...
//        scrollObject.put("toVisible", "sdfnjksdnfkld");
    ...
    public void swippingTillElementFound(MobileElement element, String direction) throws Exception {
        Dimension size = driver.manage().window().getSize();
    ...
    public void tapOnScreen(int noOfTimes) throws InterruptedException {
        for(int i=0; i<noOfTimes; i++) {
            TouchAction t = new TouchAction(driver);
            t.tap(PointOption.point(new Point(1000,1000))).waitAction(waitOptions(ofMillis(1000))).perform();
        }
